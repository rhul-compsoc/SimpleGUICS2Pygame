...
if __name__ == '__main__':
    ...
    print("""
<h2>Images</h2>""", file = f)
    make_links.print_html_list_img(make_links.read_txt(DIR_DATA + 'img_links.txt'), f)

    print("""
<h2>Sounds</h2>""", file = f)
    make_links.print_html_list_snd(make_links.read_txt(DIR_DATA + 'snd_links.txt'), f)
